...
PinchedCube::PinchedCube(bool wired)
{	
	this->wired = wired;
...
{	
	//cout << " We got to rendering the PinchedCube " << endl;
	...
	// Now draw the PinchedCube. We simply need to bind the VAO associated with it.
	glBindVertexArray(VAO);
