...
SlantedTop::SlantedTop(bool wired)
{	
	this->wired = wired;
...
{	
	...
	// Now draw the SlantedTop. We simply need to bind the VAO associated with it.
	glBindVertexArray(VAO);
