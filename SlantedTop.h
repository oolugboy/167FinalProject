#ifndef _SLANTEDTOP_H
#define _SLANTEDTOP_H
...
class SlantedTop : public Geode
{
public:
	SlantedTop(bool wired);
	~SlantedTop();	
	void spin(float);
	void render();
	...
	// Define the coordinates and indices needed to draw the SlantedTop. Note that it is not necessary
