...
void Pyramid::render()
{	
	//cout << " We got to rendering the Pyramid " << endl;
	...
	// Now draw the Pyramid. We simply need to bind the VAO associated with it.
	glBindVertexArray(VAO);
